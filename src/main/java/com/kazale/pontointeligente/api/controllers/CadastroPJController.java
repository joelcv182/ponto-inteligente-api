...
public class CadastroPJController {
	...
	/**
	 * Cadastro de pessoa juridica no sistema
	 * 
	 * @param cadastroPJDto
	 * @param result
	 * @return ResponseEntity<Resposne<CadastroPJDto>>
	...
	public ResponseEntity<Response<CadastroPJDto>> cadastrar(@Valid @RequestBody CadastroPJDto cadastroPJDto,
		...
		Funcionario funcionario = this.converterFuncionarioDtoParaFuncionario(cadastroPJDto, result);
		 ...
		 * @throws NoSuchAlgorithmException
		 */
		private Funcionario converterFuncionarioDtoParaFuncionario(CadastroPJDto cadastroPJDto, BindingResult result)
				throws NoSuchAlgorithmException{
